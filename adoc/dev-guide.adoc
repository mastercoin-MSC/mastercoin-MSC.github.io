...
The Bitcoin RPC API is documented in the https://en.bitcoin.it/wiki/Original_Bitcoin_client/API_Calls_list[Bitcoin API Calls List]. This section documents the additional commands being added by Mastercoin.
...
| getMPbalance
| <address> <currencyID>
| Retrieve balance of MP currency/property & address pair
| N
| Implemented

| listMPtransactions
| <address> <currencyID>
| List history of MP currency/property & address pair
| N
| To Do

| sendMPsimple
| <fromaddress> <toaddress> <currencyID> <amount>
| Simple send (divisibility?)
| Y
| To Do

| getMPtransaction
| <txid>
| Return JSON array of a specific MP transaction
| N
| To Do
