...
PGP is the de-facto method to ensuring your code is trusted when commiting upstream to the Mastercoin repository. To setup
...
Committing code::
Add your key to your git config with `git config --global signingkey="key identifier"` 
